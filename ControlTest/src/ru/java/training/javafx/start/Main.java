package ru.java.training.javafx.start;
...
import ru.java.training.javafx.controllers.MainController;
...
public class Main extends Application implements Observer {
    ...
    private static final String FXML_MAIN = "ru.java.training.javafx.fxml.main.fxml";
    public static final String BUNDLES_FOLDER = "ru.java.training.javafx.bundles.Locale";
